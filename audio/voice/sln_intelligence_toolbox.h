...
#ifdef SLN_DSP
SLN_DSP_Init_t                           SLN_DSP_Init                             = (SLN_DSP_Init_t) SET_THUMB_ADDRESS(0x60102094);
SLN_DSP_Deinit_t                         SLN_DSP_Deinit                           = (SLN_DSP_Deinit_t) SET_THUMB_ADDRESS(0x60102210);
SLN_DSP_SetCaptureLength_t               SLN_DSP_SetCaptureLength                 = (SLN_DSP_SetCaptureLength_t) SET_THUMB_ADDRESS(0x60102240);
SLN_DSP_GetConversionLength_t            SLN_DSP_GetConversionLength              = (SLN_DSP_GetConversionLength_t) SET_THUMB_ADDRESS(0x60102264);
SLN_DSP_SetGainFactor_t                  SLN_DSP_SetGainFactor                    = (SLN_DSP_SetGainFactor_t) SET_THUMB_ADDRESS(0x6010227C);
SLN_DSP_pdm_to_pcm_t                     SLN_DSP_pdm_to_pcm                       = (SLN_DSP_pdm_to_pcm_t) SET_THUMB_ADDRESS(0x60102290);
SLN_DSP_create_scratch_buf_t             SLN_DSP_create_scratch_buf               = (SLN_DSP_create_scratch_buf_t) SET_THUMB_ADDRESS(0x60102424);
SLN_DSP_pdm_to_pcm_multi_ch_t            SLN_DSP_pdm_to_pcm_multi_ch              = (SLN_DSP_pdm_to_pcm_multi_ch_t) SET_THUMB_ADDRESS(0x60102448);
SLN_DSP_downsample_by_3_t                SLN_DSP_downsample_by_3                  = (SLN_DSP_downsample_by_3_t) SET_THUMB_ADDRESS(0x60102690);
#endif /* SLN_DSP */
...
#ifdef SLN_Voice
SLN_Voice_Req_Mem_Size_t                 SLN_Voice_Req_Mem_Size                   = (SLN_Voice_Req_Mem_Size_t) SET_THUMB_ADDRESS(0x60102BC0);
SLN_Voice_Init_t                         SLN_Voice_Init                           = (SLN_Voice_Init_t) SET_THUMB_ADDRESS(0x6010AEAE);
SLN_Voice_Process_Audio_t                SLN_Voice_Process_Audio                  = (SLN_Voice_Process_Audio_t) SET_THUMB_ADDRESS(0x6010AED0);
SLN_Voice_Process_Wake_Word_t            SLN_Voice_Process_Wake_Word              = (SLN_Voice_Process_Wake_Word_t) SET_THUMB_ADDRESS(0x6010AF12);
#endif /* SLN_Voice */
