 ...
 ******************************************************/
extern void ble_init_gpio(void);
...
__attribute__((weak)) void ble_init_gpio(void)
{

}

static void host_platform_bt_pwr_pin_init(void)
{
	ble_init_gpio();
}
...
uint32_t host_platform_is_in_interrupt_context( void )
{
    return __get_IPSR();
}
