...
extern void __base_SRAM_OC(void);
extern void __top_SRAM_OC(void);
...
void map_flexram(void)
{
    ...
    unsigned int ocSize = (unsigned int)__top_SRAM_OC - (unsigned int)__base_SRAM_OC;
...
#define TEMP_STACK_TOP (__base_SRAM_OC + 0x8000) // Temporary stack pointer to end of first block of SRAM OC (always there)
