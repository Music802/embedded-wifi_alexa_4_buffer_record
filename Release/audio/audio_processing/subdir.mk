...
C_SRCS += \
../audio/audio_processing/pdm_to_pcm_task.c 

OBJS += \
./audio/audio_processing/pdm_to_pcm_task.o 

C_DEPS += \
./audio/audio_processing/pdm_to_pcm_task.d 


# Each subdirectory must supply rules for building sources it contributes
audio/audio_processing/%.o: ../audio/audio_processing/%.c
	@echo 'Building file: $<'
