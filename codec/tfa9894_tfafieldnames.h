...
typedef enum nxpTfa9894BfEnumList
{
    ...
    TFA9894_BF_TDMDCG =
        0x5703, /*!< Second channel gain in case of stereo using a single coil. (Total gain depending on INPLEV). (In
                   case of mono OR stereo using 2 separate DCDC channel 1 should be disabled using TDMDCE) */
...
#define TFA9894_NAMETABLE                                                                                             \
    static tfaBfName_t Tfa9894DatasheetNames[] = {                                                                    \
        ...
        {0x5703, "TDMDCG"},    /* Second channel gain in case of stereo using a single coil. (Total gain depending on \
                                  INPLEV). \    \                                                                                                                 \
                                  (In case of mono OR stereo using 2 separate DCDC channel 1 should be disabled using \
                                  TDMDCE), */                                                                         \
...
#define TFA9894_IRQ_NAMETABLE \
    static tfaIrqName_t Tfa9894IrqNames[] = {\
};
