...
/*! @brief data line status bit position */
enum _usdhc_data_line_status_flag
{
    kUSDHC_Data0LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT,      /*!< Data0 line signal level */
    kUSDHC_Data1LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT + 1U, /*!< Data1 line signal level */
    kUSDHC_Data2LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT + 2U, /*!< Data2 line signal level */
    kUSDHC_Data3LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT + 3U, /*!< Data3 line signal level */
    kUSDHC_Data4LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT + 4U, /*!< Data4 line signal level */
    kUSDHC_Data5LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT + 5U, /*!< Data5 line signal level */
    kUSDHC_Data6LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT + 6U, /*!< Data6 line signal level */
    kUSDHC_Data7LineLevelFlag = USDHC_PRES_STATE_DLSL_SHIFT + 7U, /*!< Data7 line signal level */
};
...
enum _usdhc_force_event
{
    kUSDHC_ForceEventAutoCommand12NotExecuted =
        USDHC_FORCE_EVENT_FEVTAC12NE_SHIFT,                                        /*!< Auto CMD12 not executed error */
    kUSDHC_ForceEventAutoCommand12Timeout = USDHC_FORCE_EVENT_FEVTAC12TOE_SHIFT,   /*!< Auto CMD12 timeout error */
    kUSDHC_ForceEventAutoCommand12CrcError = USDHC_FORCE_EVENT_FEVTAC12CE_SHIFT,   /*!< Auto CMD12 CRC error */
    kUSDHC_ForceEventEndBitError = USDHC_FORCE_EVENT_FEVTAC12EBE_SHIFT,            /*!< Auto CMD12 end bit error */
    kUSDHC_ForceEventAutoCommand12IndexError = USDHC_FORCE_EVENT_FEVTAC12IE_SHIFT, /*!< Auto CMD12 index error */
    kUSDHC_ForceEventAutoCommand12NotIssued = USDHC_FORCE_EVENT_FEVTCNIBAC12E_SHIFT, /*!< Auto CMD12 not issued error */
    kUSDHC_ForceEventCommandTimeout = USDHC_FORCE_EVENT_FEVTCTOE_SHIFT,              /*!< Command timeout error */
    kUSDHC_ForceEventCommandCrcError = USDHC_FORCE_EVENT_FEVTCCE_SHIFT,              /*!< Command CRC error */
    kUSDHC_ForceEventCommandEndBitError = USDHC_FORCE_EVENT_FEVTCEBE_SHIFT,          /*!< Command end bit error */
    kUSDHC_ForceEventCommandIndexError = USDHC_FORCE_EVENT_FEVTCIE_SHIFT,            /*!< Command index error */
    kUSDHC_ForceEventDataTimeout = USDHC_FORCE_EVENT_FEVTDTOE_SHIFT,                 /*!< Data timeout error */
    kUSDHC_ForceEventDataCrcError = USDHC_FORCE_EVENT_FEVTDCE_SHIFT,                 /*!< Data CRC error */
    kUSDHC_ForceEventDataEndBitError = USDHC_FORCE_EVENT_FEVTDEBE_SHIFT,             /*!< Data end bit error */
    kUSDHC_ForceEventAutoCommand12Error = USDHC_FORCE_EVENT_FEVTAC12E_SHIFT,         /*!< Auto CMD12 error */
    kUSDHC_ForceEventCardInt = USDHC_FORCE_EVENT_FEVTCINT_SHIFT,                     /*!< Card interrupt */
    kUSDHC_ForceEventDmaError = USDHC_FORCE_EVENT_FEVTDMAE_SHIFT,                    /*!< Dma error */
#if defined(FSL_FEATURE_USDHC_HAS_SDR50_MODE) && (!FSL_FEATURE_USDHC_HAS_SDR50_MODE)
    kUSDHC_ForceEventTuningError = 0U, /*!< not support */
#else
    kUSDHC_ForceEventTuningError = USDHC_FORCE_EVENT_FEVTTNE_SHIFT, /*!< Tuning error */
#endif
};
 ...
 *
 * @param base USDHC peripheral base address.
 * @param mask The force events bit posistion(1 << _usdhc_force_event).
 */
